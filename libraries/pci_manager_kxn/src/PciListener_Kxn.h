...
#ifndef PCI_H_LISTENER_KXN_H_
#define PCI_H_LISTENER_KXN_H_
...
class PciListener_Kxn {
  public:
    ...
    NK_IO_REG_TYPE io_Bit;
    volatile NK_IO_REG_TYPE *io_Reg;

    /** For internal use. Do not modify. */
    PciListener_Kxn* pciNextListener;
};
